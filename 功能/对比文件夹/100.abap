...
************************************************************************
REPORT zmrm07mlbs MESSAGE-ID m7 NO STANDARD PAGE HEADING LINE-SIZE 170.
...
FORM check_authorization.
  ...
  DATA : lt_t134t TYPE  STANDARD TABLE OF t134t,
         ls_t134t LIKE LINE OF lt_t134t.
  ...
  LOOP AT lt_t134t          INTO  ls_t134t.


    AUTHORITY-CHECK OBJECT 'ZMB52_MAT'
                   ID 'ACTVT' FIELD '03'
                   ID 'MTART' FIELD ls_t134t-mtart.

    IF NOT sy-subrc IS INITIAL.
      SET  CURSOR          FIELD  'WERKS-LOW'.
      MESSAGE e016(zmm)         WITH  ls_t134t-mtart.
    ENDIF.
...
*       check the authority after the company code changed
        ...
        AUTHORITY-CHECK OBJECT 'ZMB52_BUKS'             "waymon.
...
*  -----------------------waymon 库存地点权限 begin.
    ...
    LOOP AT lt_t001l         INTO  ls_t001l.
      ...
      AUTHORITY-CHECK OBJECT 'ZMB52_LGO'
                      ID 'ACTVT' FIELD '03'
                     ID 'WERKS' FIELD g_s_organ-werks
      ...
      IF NOT sy-subrc IS INITIAL.
        SET  CURSOR          FIELD  'WERKS-LOW'.
        MESSAGE e017(zmm)         WITH ls_t001l-lgort.
      ENDIF.
    ENDLOOP.
*  ----------waymon end.
