  method ZII_SI_OA2SAP_SALESORDER_IN~SI_OA2SAP_SALESORDER_IN.
" 变更
...
*----------------------------------------------------------------------
  ...
  IF LV_ERR_INFO IS NOT INITIAL.
      OUTPUT-mt_oa2sap_salesorder_ret-MESSAGE =  '接口开关没有打开'.
      OUTPUT-mt_oa2sap_salesorder_ret-TYPE =  'E'.
...
*----------------------------------------------------------------------
    IF G_MESSAGE_ID IS NOT INITIAL.
      CALL FUNCTION 'Z_SD_SALES_SELECT'
      EXPORTING
        INPUT      = INPUT
